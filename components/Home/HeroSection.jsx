...
const Hero = () => {
  return (
    <section
      id="home"
      className="h-screen bg-hero-mobile bg-center md:bg-hero-large w-screen bg-cover bg-no-repeat bg-fixed"
    >
      <div className="bg-gradient-to-t from-blue w-screen h-screen absolute" />
      <div className="bg-gradient-to-l from-blue w-screen h-screen absolute" />
      <div className="bg-gradient-to-b from-blue w-screen h-screen absolute md:hidden" />
