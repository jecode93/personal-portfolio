    ...
    <section>
      <div className="text-slate">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button className="w-full bg-orange-500 text-xs md:text-sm mt-5 text-blue hover:text-white hover:-translate-y-1 transition duration-500 px-3 py-2 uppercase font-medium">
            Send message
          </button>
        </form>
      </div>
